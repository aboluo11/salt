...
def get_data(*trn_tsfm):
    ...
    sp_trn_ds = ImageDataset('inputs/gray/sample/train',tsfm=trn_tsfm,train=True)
    sp_val_ds = ImageDataset('inputs/gray/sample/val',tsfm=val_tsfm,tta_tsfms=[Hflip()],train=False)
