...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, dilations, num_classes=1000):
        self.inplanes = 64
        ...
        self.layer1 = self._make_layer(block, 64, layers[0], stride=2, dilation=dilations[0])
        ...
        self.layer4 = self._make_layer(block, 512, layers[3], stride=2, dilation=dilations[3])
